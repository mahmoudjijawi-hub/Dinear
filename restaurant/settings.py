...
_allowed_hosts = os.environ.get('DJANGO_ALLOWED_HOSTS','dinear-j7hu.onrender.com' ,'localhost,127.0.0.1').split(',')
...
DATABASES = {
    'default': {
        ...
        'USER': os.environ.get('DB_USER', 'restaurant'),
        'PASSWORD': os.environ.get('DB_PASSWORD', 'restaurant123'),
